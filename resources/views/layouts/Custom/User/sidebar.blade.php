      ...
      <nav class="sidebar-main">
        ...
        <div id="sidebar-menu">
          <ul class="sidebar-links" id="simple-bar">
            ...
            <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="{{ route('user.budgets.index')}}">
                <svg class="stroke-icon">
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="{{ route('user.budgets.requests.index')}}">
                    <svg class="stroke-icon">
