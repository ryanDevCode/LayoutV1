            ...
            <ul class="nav-menus">
                ...
                <li class="profile-nav onhover-dropdown pe-0 py-0">
                    ...
                    <ul class="profile-dropdown onhover-show-div" role="menu">
                        <li role="menuitem"><a href="#"><i data-feather="user"></i><span>Account</span></a></li>
                        <li role="menuitem"><a href="#"><i data-feather="mail"></i><span>Inbox</span></a></li>
                        <li role="menuitem"><a href="#"><i data-feather="file-text"></i><span>Taskboard</span></a></li>
                        <li role="menuitem"><a href="#"><i data-feather="settings"></i><span>Settings</span></a></li>

                        @guest
                            <li role="menuitem"><a href="{{ route('login') }}"><i data-feather="log-in"></i><span>Log in</span></a></li>
                        @else
                            <li role="menuitem">
