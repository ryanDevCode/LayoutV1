        ...
        <div class="row">
            <div class="col-sm-12">
                <form class="needs-validation" novalidate=""
                    action="{{ route('admin.budgets.requests.update', ['request' => $requests->request_code]) }}" method="POST">
                    @csrf
                    @method('PUT')
                                    ...
                                    <label   class="form-label"> Plan Name</label>
                                        <div class="input-group">
                                            <input class="form-control" type="text" data-language="en"
                                                name="request_name" value="{{ $requests->request_name }}"
                                ...
                                <div class="col-md-3 mb-3">
                                    <label   class="form-label"> Amount</label>
                                        <input class="form-control" type="number" name="request_amount"
                                            value="{{ $requests->request_amount }}" required=""
                                ...
                                <div class="mb-3">
                                    <label   class="form-label"> Description</label>
                                        <textarea class="form-control"   rows="3" spellcheck="false"
                                            name="request_description" placeholder="Leave a description here..." required="" data-bs-original-title=""
                                            title="">{{ $requests->request_description }}</textarea>
                                        <div class="valid-feedback">Done!</div>
                            ...
                            <div class="row g-3">
                                <div class="mb-3">
                                    <label   class="form-label"> Reason</label>
                                        <textarea class="form-control"   rows="3" spellcheck="false"
                                            name="request_varianceReason" placeholder="Leave a reason here..." required="" data-bs-original-title=""
                                            title="">{{ $requests->request_varianceReason }}</textarea>
                                        <div class="valid-feedback">Done!</div>
                                    ...
                                    <label   class="form-label"> Approval Status</label>
                                        <select class="form-select" name="request_status" required="">
                                            @foreach ($status as $stat)
                                                @if ($stat->status_code == $requests->request_status)
                                                    <option value="{{ $stat->status_code }}" selected>
                                    ...
                                    <label   class="form-label"> Approver Name</label>
                                        <select class="form-select" name="request_approvedBy" required="">
                                            @foreach ($users as $user)
                                                @if ($user->username == $requests->request_approvedBy)
                                ...
                                <div class="col-md-6 mb-3">
                                    <label   class="form-label"> Amount</label>
                                        <input class="form-control" type="number" name="request_approvedAmount"
                                            ...
                                            title="" value="{{ $requests->request_approvedAmount }}">
                                        <div class="valid-feedback">Done!</div>
                                        <div class="invalid-feedback">Please provide a valid amount.</div>
                                </div>
                                    ...
                                    <label   class="form-label"> Approval Date</label>
                                        <div class="input-group">
                                            <input class="datepicker-here form-control digits" type="text"
                                                ...
                                                required="" value="{{ $requests->request_approvedDate }}" />
                                            <div class="valid-feedback">Done!</div>
                            ...
                            <div class="row g-3">
                                <div class="mb-3">
                                    <label   class="form-label"> Notes</label>
                                        <textarea class="form-control"   rows="3" spellcheck="false"
                                            value='{{ old('request_notes') }}' placeholder="Leave a note here..." name="request_notes"
                                            data-bs-original-title="" title="">{{ $requests->request_notes }}</textarea>
                                        <div class="valid-feedback">Done!</div>
