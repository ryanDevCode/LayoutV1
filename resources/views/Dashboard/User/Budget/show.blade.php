            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <a href="{{ route('user.budgets.create') }}" class="btn btn-primary">Add Budget</a>
                            </div>
                            <div class="col-md-6 text-end">
                                <form action="{{ route('user.budgets.search', ['department_code' => $department_code]) }}"
                                        ...
                                        @else
                                            @foreach ($budgets as $bdgt)
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <form
                                                            action="{{ route('user.budgets.edit', ['budget' => $bdgt->id]) }}"
                                                        ...
                                                        <form action="{{ route('user.budgets.destroy', $bdgt->id) }}"
