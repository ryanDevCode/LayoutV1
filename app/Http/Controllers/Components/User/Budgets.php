...
class Budgets extends Controller
{
    public function index($department_code = null)
    {
        ...
        return view('dashboard.user.budget.index   ', compact('department_code', 'budgets', 'status', 'categories', 'users', 'groupedBudgets', 'departments'));
    }
    ...
    public function create($department_code = null)
    {
        ...
        return view('dashboard.user.budget.create', compact('department_code', 'departments', 'status', 'categories', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($budgets) {
            return redirect()->route('user.budgets.show', $budgets['budget_department'])->with('success', 'Budget added successfully');
        }
    }
    ...
    public function show($department_code = null)
    {
        ...
        return view('dashboard.user.budget.show', compact('department_code', 'budgets', 'users', 'status', 'categories'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('dashboard.user.budget.edit', compact('budgets', 'departments', 'categories', 'status', 'users'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('user.budgets.show', $budget->budget_department)->with('success', 'Budget updated successfully');
    }
    ...
    public function destroy(string $id)
    {
        ...
        // Manually delete associated records in add_budgets_request
        $budget->addBudget()->delete();

        // Then delete the budget
        $budget->delete();

        return redirect()->route('user.budgets.show', $budget->budget_department)->with('success', 'Budget deleted successfully');
    }
    public function search(Request $request, $department_code = null)
    {
        ...
        if ($budgets->isEmpty() && !is_null($department_code)) {
            ...
            return view('dashboard.user.budget.show', compact('department_code'))->with('error', 'No matching records found.');
        }

        return view('dashboard.user.budget.show', compact('budgets', 'department_code', 'users', 'status', 'categories'));
    }
